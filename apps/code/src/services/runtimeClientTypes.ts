...
export type RuntimeClient = {
  ...
  workspaceFileRead: (workspaceId: string, fileId: string) => Promise<WorkspaceFileContent | null>;
  ...
  threadLiveSubscribe: (workspaceId: string, threadId: string) => Promise<Record<string, unknown>>;
  ...
  collaborationModesListV1: (workspaceId: string) => Promise<RuntimeCollaborationModesListResponse>;
  ...
  sessionExportV1: (request: RuntimeSessionExportRequest) => Promise<RuntimeSessionExportResponse>;
  sessionImportV1: (request: RuntimeSessionImportRequest) => Promise<RuntimeSessionImportResponse>;
