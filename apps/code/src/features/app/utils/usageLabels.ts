...
export function getUsageLabels(
  ...
  return {
    usageTitle: showRemaining ? "Rate limits remaining" : "Rate limits used",
    sessionLabel: showRemaining ? "Session remaining" : "Session",
    weeklyLabel: showRemaining ? "Weekly remaining" : "Weekly",
    sessionPercent,
    weeklyPercent,
