...
export function useGitHubPanelController() {
  ...
  const [gitPullRequestsState, setGitPullRequestsState] = useState<GitHubPullRequestsState>({
    pullRequests: [],
    total: 0,
    isLoading: false,
    error: null,
  ...
  const handleGitPullRequestsChange = useCallback((next: GitHubPullRequestsState) => {
  ...
  const handleGitPullRequestDiffsChange = useCallback((next: GitHubPullRequestDiffsState) => {
  ...
  const handleGitPullRequestCommentsChange = useCallback((next: GitHubPullRequestCommentsState) => {
