...
export function useDebugLog() {
  ...
  const [_debugPinned, setDebugPinned] = useState(false);
  ...
  // Keep debug panel discoverable at all times, especially when login flows fail
  // before emitting structured runtime events.
