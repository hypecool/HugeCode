export const STORAGE_KEY_PENDING_POST_UPDATE_VERSION = "hugecode.pendingPostUpdateVersion";
const GITHUB_RELEASES_API_BASE = "https://api.github.com/repos/byoungd/keep-up/releases";
const GITHUB_RELEASES_WEB_BASE = "https://github.com/byoungd/keep-up/releases";
